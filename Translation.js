  ...
  function langCheck(){
      const languageSelect = document.getElementById('language-select');
          ...
          //Projects
              ...
              document.getElementById('GotoIntern').textContent = "Stagiaire en ingénierie des processus d'affaires";
              document.getElementById('Goto1').textContent = 'Implémenter des fonctionnalités backend avec Java et Kotlin.';
              document.getElementById('Goto2').textContent = 'Gestion et résolution des tickets techniques, garantissant une livraison rapide des solutions';
              document.getElementById('Goto3').textContent = 'Collaborer avec les membres de l’équipe pour présenter et décider des solutions optimales aux problèmes complexes.';
              document.getElementById('Goto4').textContent = 'Travailler avec des bases de données PostgreSQL, et apporter les modifications nécessaires pour répondre aux exigences du projet.';
              document.getElementById('Goto5').textContent = 'Identifier et corriger un bogue critique avec succès, évitant ainsi des pertes financières importantes dues à des pannes de système causées par une surcharge de données.';
             ...
             // document.getElementById('').textContent = '';
              ...
              //Experience
              if(document.getElementById('BakeryIga') != null){
              document.getElementById('GotoIntern').textContent = 'Business Processes Engineering Intern';
              document.getElementById('Goto1').textContent = 'Implemented backend features with Java and Kotlin';
              document.getElementById('Goto2').textContent = 'Managed and resolved technical tickets, ensuring timely delivery of solutions';
              document.getElementById('Goto3').textContent = 'Collaborated with team members to present and decide on optimal solutions for complex problems.';
              document.getElementById('Goto4').textContent = 'Worked with PostgreSQL databases, making necessary alterations to meet project requirements.';
              document.getElementById('Goto5').textContent = 'Successfully identified and fixed a critical bug, preventing significant financial losses due to system crashes caused by data overload';
